...
function slideshow_path() {
  return new SageWrapping('templates/slideshow.php');
}
function agenda_path() {
  return new SageWrapping('templates/agenda.php');
}
function feed_path() {
  return new SageWrapping('templates/feed-boxes.php');
}
function presentation_path() {
  return new SageWrapping('templates/presentation.php');
}
function loader_path() {
  return new SageWrapping('templates/loader.php');
}
class SageWrapping {
